...
class RoomPenthouse302 extends Room {
    constructor(room: HTMLImageElement, canvasWidth: number, canvasHeight: number, roomNumber: number) {
        ...
        questions.push(
            new Question('Bestaad deze man?', 'dit is een deepfake', 'hij is Nep', 'Hij bestaad', 'Dit is een willekeurige foto', 'Een deepfake is een foto die is gemaakt door een computer', Game.loadNewImage('assets/img/questionImages/deepfake.jpg')),
